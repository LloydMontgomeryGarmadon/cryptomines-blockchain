...
- Fork infrastructure
- Update `--fee` options to indicate units are in KOP
...
- Offer shows network's KOP like TKOP on `testnet10` (Fixes #13393) (Thanks @yyolk)
...
- Offer CLI command help now shows `--fee` units as KOP
...
- Fixed GUI issue for CAT offers where the CAT Tail would not show in the tooltip for `Unknown CAT`s (https://github.com/Chia-Network/cryptomines-blockchain-gui/issues/950)
...
- Fixed the cryptomines-blockchain RPM to set the permission of chrome-sandbox properly.
...
- Performance improvements for nodes to support higher transaction volumes, especially for low powered devices like RaspBerry Pi. Full details at [#9050](https://github.com/Chia-Network/cryptomines-blockchain/pull/9050).
...
- Added a py.typed file that allows other projects that pip install cryptomines-blockchain to type check using our functions with mypy.
...
- Thanks to @yshklarov for help fixing [#7273](https://github.com/Chia-Network/cryptomines-blockchain/issues/7273), which bundled CA store to support pools for some farming systems, including M1 Apple computers. This enables those machines to properly connect to pools, and fixes the issue.
...
- The `src` directory in cryptomines-blockchain has been changed to `chia` to avoid namespace collisions.
...
- You should review the [release notes for v1.0.2](https://github.com/Chia-Network/cryptomines-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
- We have added Dutch and Polish to supported translations. Thanks @psydafke, @WesleyVH, @pieterhauwaerts, @bartlomiej.tokarzewski, @abstruso, @feel.the.code, and @Axadiw for contributions to [translations on Crowdin](https://crowdin.com/project/cryptomines-blockchain).
...
- Translations now available for German, Traditional Chinese, and Danish. Thanks to @Dravenex, @MaestroOnICe, @loudsyncro, @loppefaaret, @thirteenthd, @wong8888, @N418, and @swjz for all the translation help. You to can translate at our [Crowdin project](https://crowdin.com/project/cryptomines-blockchain/).
...
- Users can now pip install e.g. cryptomines-blockchain==1.0.1 on most platforms.
...
- Thank you to @L3Sota for adding a Japanese translation via our [Crowdin project](https://crowdin.com/project/cryptomines-blockchain).
...
- Migration with CRYPTOMINES_ROOT set does not crash chia init

## 1.0rc8 aka Release Candidate 8 - 2021-03-15

### Added

- This is a hard fork/breaking change from RC6/7. TKOP Coins will **not** be moved forward but your plots and keys and parts of your configuration do. When you install this version before 10AM PDST on 3/16/2021 it will load up, start finding peers, and otherwise wait for the flag drop at that time to start farming. This is likely to be the last dress rehearsal for mainnet launch. Our [3/15/2021 blog post](https://www.chia.net/2021/03/15/mainnet-update.html) has more details on the current mainnet launch plan.
...
- `chia farm summary` will now display TKOP or KOP as appropriate.
...
- PRs and commits to the cryptomines-blockchain-gui repository will automatically have their locales updated.

## Fixed

- The Farm page will now no longer get stuck at 50 TKOP farmed.
...
- We believe that the install/migrate process was bringing forward bad farming rewards receive addresses. We have attempted to stop that by only migrating RC3 and newer configurations. You can make sure you are not effected by using the Manage Farming Rewards tool mentioned above or putting a known good wallet receive address in both `kop_target_address` sections of config.yaml.
...
- The RC5 release is a new breaking change/hard fork blockchain. Plots and keys from previous chains will work fine on RC5 but balances of TKOP will not come forward.
...
- We have added Romanian to the GUI translations. Thank you to @bicilis on [Crowdin](https://crowdin.com/project/cryptomines-blockchain). We also added a couple of additional target languages. Klingon anyone?
...
- Thanks to @xdustinface of Dash, the BlS Signature library has been updated to 0.9 with clean ups and some speed ups. This changed how the G2 infinity element was handled and we now manage it inside of cryptomines-blockchain, etc., instead of in blspy.
...
- And thanks yet again to @jespino for a host of PRs to add more detailed typing to various components in cryptomines-blockchain.
...
- RC3 is a new chain to support the last major chialisp changes. TKOP from the RC1/2 chain do not come forward to this chain but plots and keys continue to work as usual.
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/Chia-Network/cryptomines-blockchain/releases/tag/1.0rc1) was well.
...
- Installers will now be of the pattern CryptominesSetup-0.2.1.exe. `0.2` is release candidate and the final `.1` is the first release candidate.
...
- We have integrated with crowdin to make it easier to translate the GUI. Check out [Chia Blockchain GUI](https://crowdin.com/project/cryptomines-blockchain) there.
- We have added Italian, Russian, and Finnish. More to come soon.
- There is now remote UI support. [Documents](https://github.com/Chia-Network/cryptomines-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/Chia-Network/cryptomines-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- 'chia wallet send' now takes in TKOP or KOP as units instead of mojos.
...
- The Beta 27 chain is a hard fork. All TKOP from previous releases has been reset on this chain. Your keys and plots of k=32 or larger continue to work just fine on this new chain.
...
- We have added the [Crowdin](https://crowdin.com/) translation platform to [chia blockchain gui](https://crowdin.com/project/cryptomines-blockchain). We are still getting it fully set up, but helping to translate the GUI is going to be much easier.
...
- This release has the final mainnet rewards schedule. During the first three years, each block winner will win 2 TKOP/KOP per block for a total of 9216 TKOP per day from 4608 challenges per day.
- Smart transactions now use an announcement instead of 'coin consumed' or lock methods.
- The GUI is now in a separate submodule repository from cryptomines-blockchain, [cryptomines-blockchain-gui](https://github.com/Chia-Network/cryptomines-blockchain-gui). The installers and install scripts have been updated and it continues to follow the same install steps. Note that the GUI directory will now be `cryptomines-blockchain-gui`. The workflow for this may be "touch and go" for people who use the git install methods over the short term.
...
- The cli wallet, `chia wallet`, was incorrectly displaying TKOP balances as if they were Coloured Coins.
...
- Significant improvements have been made to how the full node handles the mempool. This generally cuts CPU usage of node by 2x or more. Part of this increase is that we have temporarily limited the size of transactions. If you want to test sending a transaction you should keep the value of your transaction below 20 TKOP as new consensus will cause you to use a lot of inputs. This will be returned to the expected level as soon as the integration of [clvm rust](https://github.com/Chia-Network/clvm_rs) is complete.
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/Chia-Network/cryptomines-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- Welcome to the new consensus. This release is an all but a full re-write of the blockchain in under 30 days. There is now only one tip of the blockchain but we went from two chains to three. Block times are now a little under a minute but there are a couple of sub blocks between each transaction block. A block is also itself a special kind of sub block and each sub block rewards the farmer who won it 1 TKOP. Sub blocks come, on average, about every 17 to 18 seconds.
- Starting with this Beta, there are 4608 opportunities per day for a farmer to win 1 TKOP compared to Beta 18 where there were 288 opportunities per day for a farmer to win 16 TKOP.
...
- New consensus means this is a very hard fork. All of your TKOP from Beta 17/18 will be gone. Your plots and keys will work just fine however. You will have to sync to the new chain.
...
- Prior to this Beta 19, we had block times that targeted 5 minutes and rewarded 16 TKOP to one farmer. Moving forward we have epoch times that target 10 minutes and reward 32 TKOP to 32 farmers about every 17-18 seconds over that period. This has subtle naming and UI impacts in various places.
...
- The Farm tab in the GUI is significantly enhanced. Here you have a dashboard overview of your farm and your activity in response to challenges blockchain challnegs, how long it will take you - on average - to win a block, and how much TKOP you've won so far. Harvester and Full Node connections have moved to Advanced Options.
...
- Changes were made to chiapos to correctly support the new bitfiled backpropogation on FreeBSD and OpenBSD. With the exception of needing to work around python cryptography as outlined on the wiki, FreeBSD and OpenBSD should be able to compile and run cryptomines-blockchain.
...
- A segfault caused by memory leaks in bls-library has been fixed. This should end the random farmer and harvester crashes over time as outlined in [Issue 500](https://github.com/Chia-Network/cryptomines-blockchain/issues/500).
...
- FreeBSD and OpenBSD should be able to build and install cryptomines-blockchain and its dependencies again.
...
- In the GUI there was [a regression](https://github.com/Chia-Network/cryptomines-blockchain/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/Chia-Network/cryptomines-blockchain/issues/485) where log level could no longer be set by service.
...
- The GUI now supports translations and localizations. If you'd like to add your language you can see the examples in [the locales directory](https://github.com/Chia-Network/cryptomines-blockchain/tree/dev/electron-react/src/locales) of the cryptomines-blockchain repository.
...
`~\AppData\Local\cryptomines-blockchain\app-0.1.8\resources\app.asar.unpacked\daemon\`
in Windows or
...
- Changed KOP units to TKOP units for testnet.
...
- We added [lgtm](https://lgtm.com/) source analysis on pull request to the cryptomines-blockchain, chiapos, chiavdf, chiabip158, and bls-library repositories to add some automated security analysis to our ci.
...
- The user interface now refers to chia coins with their correct currency code of KOP.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/Chia-Network/cryptomines-blockchain/wiki) and placed in [INSTALL](https://github.com/Chia-Network/cryptomines-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/Chia-Network/cryptomines-blockchain/wiki/Quick-Start-Guide)
...
- We suggest you take a look at our [Upgrading documentation](https://github.com/Chia-Network/cryptomines-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/Chia-Network/cryptomines-blockchain/wiki/Beta-1.4-k=32-or-larger-work-around).
...
- We have revamped the chia management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `chia-start-farmer &`. The [README.md](https://github.com/Chia-Network/cryptomines-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
- Configuration directories have been moved to a default location of HomeDirectory/.chia/release/config, plots/ db/, wallet/ etc. This can be overridden by `export CRYPTOMINES_ROOT=~/.chia` for example which would then put the plots directory in `HomeDirectory/.chia/plots`.
- The libraries chia-pos, chia-fast-vdf, and chia-bip-158 have been moved to their own repositories: [chiapos](https://github.com/Chia-Network/chiapos), [chiavdf](https://github.com/Chia-Network/chiavdf), and [chaibip158](https://github.com/Chia-Network/chiabip158). They are brought in by cryptomines-blockchain at install time. Our BLS signature library remains at [bls-signatures](https://github.com/Chia-Network/bls-signatures).
...
- Chia fullnode, farmer and harvester now default to logging to chia.log in the cryptomines-blockchain directory. This is configured in config.yaml and due to config.yaml changes it is recommended to edit the new template config instead of using older config.yaml’s from previous versions.
...
[unreleased]: https://github.com/Chia-Network/cryptomines-blockchain/compare/1.0beta5...dev
[1.0beta5]: https://github.com/Chia-Network/cryptomines-blockchain/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/Chia-Network/cryptomines-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/Chia-Network/cryptomines-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/Chia-Network/cryptomines-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/Chia-Network/cryptomines-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/Chia-Network/cryptomines-blockchain/releases/tag/Alpha-1.0
