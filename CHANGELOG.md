...
- Offer shows network's XCH like TKOP on `testnet10` (Fixes #13393) (Thanks @yyolk)
...
- `chia farm summary` will now display TKOP or XCH as appropriate.
...
- 'chia wallet send' now takes in TKOP or XCH as units instead of mojos.
...
- This release has the final mainnet rewards schedule. During the first three years, each block winner will win 2 TKOP/XCH per block for a total of 9216 TKOP per day from 4608 challenges per day.
...
- Changed XCH units to TKOP units for testnet.
