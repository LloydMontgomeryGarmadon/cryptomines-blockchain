    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.chiablockchain.pl"
                testnet_dns_introducer = "introducer-testnet10.chiablockchain.pl"
                bootstrap_peers = ["testnet10-node.chiablockchain.pl"]
                testnet = "testnet10"
                ...
                mainnet_port = "44411"
                mainnet_introducer = "introducer.chiablockchain.pl"
                mainnet_dns_introducer = "dns-introducer.chiablockchain.pl"
                bootstrap_peers = ["node.chiablockchain.pl"]
                net = "mainnet"
