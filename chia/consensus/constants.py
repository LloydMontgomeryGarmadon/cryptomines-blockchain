...
class ConsensusConstants:
    ...
    # Forks of cryptomines should change this value to provide replay attack protection
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M cryptomines.
    MAX_COIN_AMOUNT: int
